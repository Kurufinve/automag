...
run = SubmitManual(standardized_structure_name, mode='mae_theta_phi', fix_params=params, magmoms=standardized_magmom,  
                     struct_suffix=struct_suffix, Nth = Nth, Nph = Nph,
